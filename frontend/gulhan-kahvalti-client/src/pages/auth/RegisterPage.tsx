  ...
  return (
    <section className="mx-auto max-w-md rounded-3xl border border-cyan-100 bg-white p-6 shadow-brand dark:border-white/10 dark:bg-slate-900">
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-2xl font-bold text-stone-950 dark:text-white">{t('register')}</h1>
        <p className="mt-2 text-sm text-stone-600 dark:text-slate-300">{t('registerDescription')}</p>
      </div>
