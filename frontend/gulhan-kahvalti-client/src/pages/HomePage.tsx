    ...
    <section className="grid gap-6 sm:gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
      <div className="space-y-5">
        <p className="text-sm font-semibold uppercase tracking-wide text-emerald-700">
          Yerel kahvaltı lezzetleri
        </p>
        <h1 className="text-3xl font-bold tracking-tight text-stone-950 sm:text-5xl">
          {t('brand')}
        </h1>
        <p className="max-w-2xl text-base leading-7 text-stone-600">
          Menüyü inceleyebileceğiniz, ürünleri sepete ekleyebileceğiniz ve demo
          sipariş akışını deneyebileceğiniz MVP vitrin.
        </p>
      ...
      <div className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm sm:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-stone-600">
          Bu ekranda ilerleyen fazlarda işletme tanıtımı, öne çıkan ürünler ve
          iletişim alanları yer alacak.
        </p>
      </div>
    </section>
  )
